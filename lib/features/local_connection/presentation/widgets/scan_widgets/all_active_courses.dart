...
class AllActiveCourses extends StatelessWidget {
  const AllActiveCourses({Key? key,required this.activatedCourses,required this.prefs}) : super(key: key);
 ...
 final  List<Map<String,String>> activatedCourses;
  ...
  ListView allActiveCourses() {
    return ListView.builder(
        ...
        itemBuilder: (_, index) {
          return ActiveCoursesTail(courseValue: activatedCourses[index], prefs: prefs,);
        });
  }
