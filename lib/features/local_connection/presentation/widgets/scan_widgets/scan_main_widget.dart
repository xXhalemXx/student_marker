...
class ScanMainWidget extends StatelessWidget {
  const ScanMainWidget({Key? key,required this.availableCourses,required this.prefs}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children:  [
        ...
        Expanded(
          flex: 6,
          child: AllActiveCourses(activatedCourses: availableCourses, prefs: prefs,),
        )
      ],
    );
  }
